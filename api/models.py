...
class Servico(models.Model):
    ...
    data = models.DateTimeField(default=timezone.now)  # Define como a data/hora atual


    def __str__(self):
        return f"Servico(nome={self.nome}, descricao={self.descricao[:30]}..., preco={self.preco}, data={self.data})"
